...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(OnlineWalletException.class)
	public @ResponseBody ResponseEntity<ErrorInfo>  handleException(OnlineWalletException ex,HttpServletRequest req)
	{
